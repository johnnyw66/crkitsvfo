/*
 * "Sandwich Digital VFO" control software for CRKits KN-Q7A SSB transceiver kit 80 meter version and later on versions
 * 
...
unsigned long op_freq, band_low_limit = 3500000, band_high_limit, bfo_freq, bfo_low_limit, bfo_high_limit, temp_op_freq, temp_bfo_freq, target_freq = 10000000, rx_freq = 10000000;
...
void setup ()
{
  ...
  */
  ...
  {
    op_freq = 3700000;  //set op_freq to the mid of the band
    band_high_limit = 3800000;  //set band high limit to 3.8 MHz for Europe and etc
  ...
  {
    op_freq = 3700000;  //set op_freq to the mid of the band
    band_high_limit = 3900000;  //set band high limit to 3.9 MHz for Asia and etc
    bfo_freq = 8465300;     //IF freq = 8467.2 kHz, BFO freq is around IF freq depending on LSB or USB, default to LSB
    bfo_low_limit = 8464700;
    bfo_high_limit = 8468700;
  }
